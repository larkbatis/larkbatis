 ...
 * official mechanism behind {@code ${}} (design §08) and the manual escape
 * hatch (design §09): a {@code String} never reaches the SQL text directly.
 *
...
public final class SqlFragment {
    ...
    public static SqlFragment allowed(String value, String... allowed) {
        ...
        throw new LightBatisRejectedException(value, allowed);
    }
    ...
    public static SqlFragment identifier(String value) {
        if (value == null || !IDENT.matcher(value).matches()) {
            throw new LightBatisRejectedException(value);
        }
