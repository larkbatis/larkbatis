 ...
 * demand — the "FaultyDataSource" trick from the build plan (§05): it turns
 * the four hardest transaction tests from "provision a broken database" into
 * plain assertions. Proxy-based; reflection is fine in test code, it is the
