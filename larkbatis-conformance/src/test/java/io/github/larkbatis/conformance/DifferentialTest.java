...
import io.github.larkbatis.conformance.fixtures.ConformanceUserMapper;
...
/**
 * The differential suite: MyBatis is the oracle; the SQL
...
class DifferentialTest {
    ...
    private static void assertIdentical(Consumer<ConformanceUserMapper> call) {
        ...
        Recording generated = DifferentialHarness.larkbatis(
                LarkBatisMappers::conformanceUserMapper, call);
    ...
    /**
     * See the two SQL strings side by side. Not an assertion — the visible
     * starting point of every future diff.
     */
    @Test
    void printBothSides() {
        ...
        System.out.println("=== LarkBatis (generated) ===");
        System.out.print(DifferentialHarness.larkbatis(
                LarkBatisMappers::conformanceUserMapper, call).dump());
    }
}
