...
class SqlFragmentTest {
    ...
    void allowedRejectsAnythingOutsideTheWhitelist() {
        LarkBatisRejectedException e = assertThrows(LarkBatisRejectedException.class,
    ...
    void identifierRejectsEverythingElse() {
        assertThrows(LarkBatisRejectedException.class, () -> SqlFragment.identifier("users; --"));
        assertThrows(LarkBatisRejectedException.class, () -> SqlFragment.identifier("a.b.c"));
        assertThrows(LarkBatisRejectedException.class, () -> SqlFragment.identifier("1users"));
        assertThrows(LarkBatisRejectedException.class, () -> SqlFragment.identifier(""));
        assertThrows(LarkBatisRejectedException.class, () -> SqlFragment.identifier(null));
        assertThrows(LarkBatisRejectedException.class, () -> SqlFragment.identifier("na me"));
    }

    @Test
    void noFactoryProducesAnEmptyFragment() {
        // ORDER BY ${sort} with a null/empty value must fail at the call site,
        // not become "ORDER BY " and blow up inside the database
        assertThrows(LarkBatisRejectedException.class, () -> SqlFragment.unsafeRawSql(null));
        assertThrows(LarkBatisRejectedException.class, () -> SqlFragment.unsafeRawSql(""));
        assertThrows(LarkBatisRejectedException.class, () -> SqlFragment.unsafeRawSql("   "));
    }
