...
import io.github.lightbatis.processor.frontend.TypeResolver;
import io.github.lightbatis.processor.ir.MapperModel;
import java.util.List;
import javax.lang.model.element.Modifier;

/**
 * Emits {@code LightBatisMappers}: the static, closed list of mappers
 * (design §08 group 3 — replaces classpath scanning; nothing is registered at
 * runtime). One factory method per mapper.
 */
public final class RegistryEmitter {

    public static final String REGISTRY_SIMPLE_NAME = "LightBatisMappers";
    ...
    public static String emit(String packageName, List<MapperModel> mappers) {
        TypeSpec.Builder type = TypeSpec.classBuilder(REGISTRY_SIMPLE_NAME)
                ...
                .addJavadoc("The closed set of LightBatis mappers, known at compile time"
